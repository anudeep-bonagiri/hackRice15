      ...
      <section className="bg-gradient-primary text-primary-foreground py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Welcome to <span className="font-black text-6xl md:text-7xl bg-gradient-to-r from-white via-primary-foreground to-primary-light bg-clip-text text-transparent drop-shadow-lg">GrowFi</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              className="btn-cta text-lg px-8 py-4 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              Start Your Journey
